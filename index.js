...
//services related api
    ...
    // get single service data related api
...
app.get('/', async (req, res) => {
  res.send({ message: "Car Doctor Server Running!!" });
});
